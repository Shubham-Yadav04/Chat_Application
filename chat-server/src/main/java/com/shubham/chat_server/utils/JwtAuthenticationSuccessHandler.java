...
User createdUser=userService.createUser(user);
        ...
        String jwtAccessToken = jwtService.generateToken(oauth2User.getAttribute("name"), 1000 * 60 * 60); // 1 hour
        String jwtRefreshToken = jwtService.generateToken(oauth2User.getAttribute("name"), 1000 * 60 * 60 * 24 * 10); // 10 days
